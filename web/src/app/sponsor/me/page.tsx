...
//   const [projectsCountRes, sentInquiriesRes, unreadRepliesRes, projectsRes, repliesRes] =
//     await Promise.all([
...
//               <Link href="/sponsor/edit" className="rounded-xl bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur hover:bg-white/20">
//                 Edit profile
//               </Link>

//               {/* Optional sign out (present if you added SignOutButton) */}
...
//               <Action href="/messages" label="Open message center" sub="Continue conversations" />
//             </div>
//           </div>
//         </section>
...
//         {/* Footer tone bar (kept consistent across app) */}

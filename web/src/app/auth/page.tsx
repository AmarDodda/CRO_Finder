...
//       <div className="w-full max-w-md border rounded-2xl bg-white p-6 shadow-sm">
//         <div className="text-xs uppercase tracking-wide text-gray-500">
//           {urlRole === "cro" ? "CRO" : "Sponsor"} Portal
//         </div>
//         <h1 className="text-2xl font-semibold mt-1">
//           {mode === "login" ? "Log in" : "Sign up"}
//         </h1>
//         <p className="text-sm text-gray-600 mt-1">
//           {urlRole === "cro" ? "Create or access your CRO account." : "Create or access your sponsor account."}
//         </p>
...
//           <button className="bg-black text-white px-4 py-2 rounded w-full" disabled={busy}>
...
// //   // Sponsor flow: only go to /sponsor/me if onboarded OR already has projects
// //   const { data: profile } = await supabase
// //     .from("user_profiles")
// //     .select("sponsor_onboarded")
// //     .eq("id", uid)
// //     .single();

// //   if (profile?.sponsor_onboarded) {
// //     router.replace("/sponsor/me");
// //     return;
// //   }

// //   // Fallback: do they own any projects?
...
//   // CRO flow
//   const { data: croRows, error: croErr } = await supabase
//     .from("cros")
//     .select("id")
//     .eq("owner", uid)
//     .order("created_at", { ascending: false })
...
//   if (roleParam === "cro") {
//     if (ownedCroId) {
//       router.replace("/cros/me");       // existing CRO -> dashboard
//     } else {
//       router.replace("/cros/new");      // first-time CRO -> onboarding
//     }
//     return;
//   }

//   // Sponsor flow:
//   // Show dashboard ONLY if the sponsor already has at least one project
//   // OR has any chat activity. Otherwise go to project intake.
...
//   // Optional: also treat “has any messages” as returning user
